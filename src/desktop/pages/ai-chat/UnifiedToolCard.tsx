...
const ToolStatus: React.FC<{ toolCall: UIToolCallInfo }> = ({ toolCall }) => {
  if (toolCall.status === 'streaming') {
    return (
      <span className={desktopStyles.AIChatToolStatusNeutral}>
  ...
  if (toolCall.type === 'confirm') {
    if (toolCall.status === 'confirmed') {
      return (
        <span className={desktopStyles.AIChatToolStatusSuccess}>
    ...
    return (
      <span className={desktopStyles.AIChatToolStatusWarning}>
  ...
  return (
    <span className={desktopStyles.AIChatToolStatusDanger}>
