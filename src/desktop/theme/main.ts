...
export const desktopStyles = {
  ...
  AIChatMessageUserBubble: /*tw*/ 'flex max-w-full flex-col gap-1 rounded-xl bg-bg3 px-3 py-2 text-sm leading-5 text-t1',
  ...
  AIChatToolStatusNeutral: /*tw*/ 'flex items-center gap-1 text-xs text-t3',
  AIChatToolStatusSuccess: /*tw*/ 'flex items-center gap-1 text-xs text-accent-success',
  AIChatToolStatusWarning: /*tw*/ 'flex items-center gap-1 text-xs text-accent-warning',
  AIChatToolStatusDanger: /*tw*/ 'flex items-center gap-1 text-xs text-accent-danger',
  ...
  AIChatToolCardConfirmButton: /*tw*/ 'rounded-md bg-brand px-3 py-1.5 text-xs text-white transition-opacity hover:opacity-90',
  ...
  CommandPaletteResultItemEntityAreaIcon: /*tw*/ 'size-4',
  CommandPaletteResultItemParentAreaIcon: /*tw*/ 'size-3',
  CommandPaletteResultItemParentInboxIcon: /*tw*/ 'size-3',
