...
export const DayButton: React.FC<DayButtonProps> = ({ day, onSelect }) => {
  ...
  return (
    <button
      ...
      className={classNames(styles.datePickerDayButtonHeight, styles.datePickerDayButtonRound, styles.datePickerDayButtonBase, {
    ...
    >
      {isTodayValue && (
        <span className={styles.datePickerTodayLabel}>
